...
class Post(models.Model):
    ...
    def save(self, *args, **kwargs): 
        ...
        #internal plagiarism
        internal_plag=0
        for fil in os.listdir(r'C:\Users\user\Desktop\SEM7\CAPSTONE\PlagiarismChecker\media\Assignments'):
            if fil.endswith('.docx'):
                my_friend_text = docx2txt.process('C:\\Users\\user\\Desktop\\SEM7\\CAPSTONE\\PlagiarismChecker\\media\\Assignments\\'+fil)
                #print(my_text)
